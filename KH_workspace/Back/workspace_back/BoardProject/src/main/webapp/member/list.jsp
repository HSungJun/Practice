...
<body>
	...
	<form action="/update.members" method="post" id="form">
		<table border=1 align=center>
			...
			<tr>
				<td>PW</td>
				<td><input type=text name="pw" id="id" readonly></td>
			</tr>
			<tr>
				<td>NAME</td>
				<td><input type=text value="${name }" id="name" name="name"
					readonly></td>
			</tr>
			<tr>
				<td>PHONE</td>
				<td><input type=text value="${phone }" id="phone" name="phone"
					readonly></td>
			</tr>
			<tr>
				<td>EMAIL</td> 
			...
			<tr>
				<td>ZIPCODE</td>
				<td><input type=text value="${zip }" id="zipcode"
					name="zipcode" readonly>
					<button type="button" id="search">우편번호 찾기</button></td>
			</tr>
			<tr>
				<td>ADDRESS1</td>
				<td><input type=text value="${add1 }" id="address1"
					name="address1" readonly></td>
			</tr>
			<tr>
				<td>ADDRESS2</td>
				<td><input type=text value="${add2 }" id="address2"
